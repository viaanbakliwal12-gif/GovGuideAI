...
const authAndGuestTranslations = {
  en: {
    loginPasswordCopy: "Use your email and password to access your saved profile.",
    adminDashboard: "Admin Dashboard",
    administratorSetup: "Administrator Setup",
    signupPasswordCopy: "Create a secure account, then complete your profile for personalized guidance.",
    ...
    passwordAuthPrivacy: "Your password is securely hashed. GovGuideAI never stores or displays the plain-text password.",
