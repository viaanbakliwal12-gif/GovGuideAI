...
const translations = {
  en: {
    ...
    profileSetupCopy: "This helps GovGuideAI suggest schemes and services without asking you to repeat basic details. Do not enter Aadhaar, PAN, bank details, security codes, or exact home address.",
    profilePrivacyDetailsTitle: "How profile information is handled",
    profilePrivacyDetails: "Your profile is stored for personalized recommendations, may be accessed only by authorized administration, and is not used for advertising. You can edit or delete your profile or account. Do not enter Aadhaar numbers, bank details, passwords, security codes, or other highly sensitive information.",
    signupPrivacy: "Your profile is used only to personalize government-service and scheme guidance. Do not enter Aadhaar, PAN, bank details, security codes, or exact home address.",
  ...
  hi: {
    ...
    profileSetupCopy: "इससे GovGuideAI बार-बार जानकारी पूछे बिना योजनाएँ और सेवाएँ सुझा सकता है। आधार, पैन, बैंक विवरण, security code या पूरा पता न लिखें।",
    signupPrivacy: "आपकी प्रोफ़ाइल केवल सरकारी सेवा और योजना मार्गदर्शन को व्यक्तिगत बनाने के लिए उपयोग होती है। आधार, पैन, बैंक विवरण, security code या पूरा पता न लिखें।",
  ...
  mr: {
    ...
    profileSetupCopy: "यामुळे GovGuideAI पुन्हा तपशील न विचारता योजना आणि सेवा सुचवू शकते. आधार, PAN, बँक तपशील, security code किंवा पूर्ण पत्ता देऊ नका.",
...
const authAndGuestTranslations = {
  en: {
    loginOtpCopy: "Enter your email and we will send a six-digit sign-in code.",
    adminDashboard: "Admin Dashboard",
    administratorSetup: "Administrator Setup",
    emailAddress: "Email address",
    otpEmailHelp: "We will only use this address to send your secure login code.",
    sendOtp: "Send OTP",
    sendingOtp: "Sending...",
    enterOtp: "Enter your code",
    codeSentTo: "A six-digit code was sent to",
    changeEmail: "Change Email",
    sixDigitOtp: "Six-digit OTP",
    otpHelp: "Enter the code from your Supabase email. You can paste all six digits.",
    verifyOtp: "Verify OTP",
    verifyingOtp: "Verifying...",
    resendCode: "Resend Code",
    resendingOtp: "Resending...",
    otpSent: "OTP sent. Check your email for the six-digit code.",
    otpResent: "A new six-digit OTP was sent. Check your email.",
    otpVerified: "OTP verified. Opening GovGuideAI...",
    otpLength: "Enter the complete six-digit OTP.",
    otpInvalid: "That OTP is incorrect or no longer valid. Check the code or request a new one.",
    otpExpired: "That OTP has expired. Request a new code and try again.",
    otpRateLimited: "Too many code requests. Wait a minute, then try again.",
    otpSendError: "The OTP could not be sent. Please try again.",
    otpVerifyError: "The OTP could not be verified. Please try again.",
    networkError: "Network error. Check your connection and try again.",
    supabaseLibraryError: "The Supabase login library could not load. Check your network and refresh.",
    supabaseConfigError: "Supabase login is not configured. Set SUPABASE_URL and SUPABASE_ANON_KEY on the server.",
    sessionMissing: "Supabase did not return a valid session.",
    sessionSyncError: "GovGuideAI could not start your website session.",
    restoringSession: "Restoring your session...",
    loggingOut: "Logging out...",
    deletingAccount: "Deleting account...",
    logoutError: "Logout failed. Check your connection and try again.",
    or: "or",
    ...
    otpAuthPrivacy: "Supabase generates, emails, and verifies each code. GovGuideAI never generates or stores OTP codes.",
    confirmPassword: "Confirm password",
    passwordHelp: "Use 10 or more characters with at least one letter and one number.",
    ...
    passwordMinimum: "Use at least 10 characters.",
    openMenu: "Open menu",
    close: "Close",
  ...
  hi: {
    continueAsGuest: "अतिथि के रूप में जारी रखें", reducedPersonalization: "कम व्यक्तिगत सुझाव", createAccountToSave: "अपनी जानकारी सहेजने के लिए खाता बनाएं", guestMode: "अतिथि मोड", guestExplanation: "आप बिना खाता बनाए GovGuideAI का उपयोग कर सकते हैं। सुझाव कम व्यक्तिगत हो सकते हैं और प्रोफ़ाइल व चैट इतिहास सहेजा नहीं जाएगा।", },
  mr: {
    continueAsGuest: "अतिथी म्हणून पुढे जा", reducedPersonalization: "मर्यादित वैयक्तिकरण", createAccountToSave: "माहिती जतन करण्यासाठी खाते तयार करा",
  },
  bn: {
    continueAsGuest: "অতিথি হিসেবে চালিয়ে যান", reducedPersonalization: "সীমিত ব্যক্তিগতকরণ", createAccountToSave: "তথ্য সংরক্ষণ করতে অ্যাকাউন্ট তৈরি করুন",
  },
  ta: {
    continueAsGuest: "விருந்தினராக தொடரவும்", reducedPersonalization: "குறைந்த தனிப்பயனாக்கம்", createAccountToSave: "தகவலைச் சேமிக்க கணக்கு உருவாக்கவும்",
  },
  te: {
    continueAsGuest: "అతిథిగా కొనసాగండి", reducedPersonalization: "తక్కువ వ్యక్తిగతీకరణ", createAccountToSave: "సమాచారాన్ని సేవ్ చేయడానికి ఖాతా సృష్టించండి",
  },
  gu: {
    continueAsGuest: "મહેમાન તરીકે આગળ વધો", reducedPersonalization: "ઓછું વ્યક્તિગતકરણ", createAccountToSave: "માહિતી સાચવવા ખાતું બનાવો",
  },
  kn: {
    continueAsGuest: "ಅತಿಥಿಯಾಗಿ ಮುಂದುವರಿಸಿ", reducedPersonalization: "ಕಡಿಮೆ ವೈಯಕ್ತೀಕರಣ", createAccountToSave: "ಮಾಹಿತಿ ಉಳಿಸಲು ಖಾತೆ ರಚಿಸಿ",
  },
  ml: {
    continueAsGuest: "അതിഥിയായി തുടരുക", reducedPersonalization: "കുറഞ്ഞ വ്യക്തിഗതമാക്കൽ", createAccountToSave: "വിവരങ്ങൾ സൂക്ഷിക്കാൻ അക്കൗണ്ട് സൃഷ്ടിക്കുക",
  },
  pa: {
    continueAsGuest: "ਮਹਿਮਾਨ ਵਜੋਂ ਜਾਰੀ ਰੱਖੋ", reducedPersonalization: "ਘੱਟ ਨਿੱਜੀਕਰਨ", createAccountToSave: "ਜਾਣਕਾਰੀ ਸੰਭਾਲਣ ਲਈ ਖਾਤਾ ਬਣਾਓ",
  },
  ur: {
    continueAsGuest: "مہمان کے طور پر جاری رکھیں", reducedPersonalization: "کم ذاتی نوعیت", createAccountToSave: "معلومات محفوظ کرنے کے لیے اکاؤنٹ بنائیں",
  },
};
