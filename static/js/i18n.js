...
const authAndGuestTranslations = {
  en: {
    loginEmailCopy: "Enter your email to continue. No password or verification is required.",
    adminDashboard: "Admin Dashboard",
    administratorSetup: "Administrator Setup",
    emailAddress: "Email address",
    emailLoginHelp: "Existing local accounts are reused automatically; otherwise a new account is created.",
    continueWithEmail: "Continue with Email",
    emailOnlyPrivacy: "Submitting the form signs you in immediately with the local Flask session.",
    or: "or",
